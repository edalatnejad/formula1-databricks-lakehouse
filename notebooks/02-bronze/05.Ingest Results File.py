...
table_name = f"{catalog_name}.{bronze_schema}.results"# Databricks notebook source
...
results_final_df = add_ingestion_metadata(results_df)# Databricks notebook source
