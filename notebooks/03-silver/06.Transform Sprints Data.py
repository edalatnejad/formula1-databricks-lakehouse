...
silver_table = f"{catalog_name}.{silver_schema}.sprints"# Databricks notebook source
...
display(sprints_df.count() - sprints_valid_df.count())# Databricks notebook source
...
display(sprints_final_df)# Databricks notebook source
